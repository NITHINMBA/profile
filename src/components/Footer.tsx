    ...
    <footer className="border-t border-gray-200">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10 text-center">
        <div className="flex items-center justify-center gap-6">
          <a href="https://github.com/placeholder" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-2 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600">
          ...
          <a href="https://www.linkedin.com/in/placeholder" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="p-2 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600">
            <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{ filter: 'grayscale(1)' }}>
          ...
          <a href="mailto:placeholder@email.com" aria-label="Email" className="p-2 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600">
            <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{ filter: 'grayscale(1)' }}>
        ...
        <p className="mt-6 text-sm text-gray-500">Copyright © Nithin 2025</p>
      </div>
    </footer>
  );
};
